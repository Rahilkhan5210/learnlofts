...
import { useCreateBlogMutation } from "../../../Features/Api/blogsApi";
...
const AddBlogs = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await createBlog(dataToSubmit).unwrap();
      ...
      alert("Failed to create blog: " + (error.data?.error || error.message || 'Unknown error'));
    }
  };
